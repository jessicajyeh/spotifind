...
var client_id = '6535d102b8634994a7f366e1a7a51892'; // Your client id
var client_secret = '364ff13b2f064c378a6eaa07c9a200a2'; // Your secret
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        request.get(playlist_options, function(error, response, body) {
          console.log(body);
        });
